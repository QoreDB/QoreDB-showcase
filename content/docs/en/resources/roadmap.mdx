...
- **Open a GitHub issue** at [github.com/QoreDB/QoreDB/issues](https://github.com/QoreDB/QoreDB/issues) with a clear use case. Describe what you're trying to do, not just what you want changed; that helps frame the discussion around the actual problem.
