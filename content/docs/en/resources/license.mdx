...
When in doubt about a specific case, the [LICENSE](https://github.com/QoreDB/QoreDB/blob/main/LICENSE) and [LICENSE-BSL](https://github.com/QoreDB/QoreDB/blob/main/LICENSE-BSL) files have the legal text.
