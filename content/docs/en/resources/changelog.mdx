...
- **GitHub Releases**: the raw release notes, attached binaries, and tagged source. Useful if you want to grab a specific version's installer or read the verbatim release text. See [github.com/QoreDB/QoreDB/releases](https://github.com/QoreDB/QoreDB/releases).
