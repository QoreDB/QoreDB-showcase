...
- **All database drivers**: PostgreSQL, MySQL, SQL Server, SQLite, MongoDB, Redis, DuckDB, CockroachDB
...
- **Sandbox mode**, **audit logging**, **read-only mode**, **dangerous query detection**
...
<Screenshot
  alt="ER Diagram view in QoreDB with the Premium badge visible"
  todo="Screenshot of the ER Diagram tab open on a real schema (5–8 tables with relationships), showing the 'Pro' or 'Premium' badge in the toolbar or near the feature name. Make sure the diagram has at least 2 visible foreign-key edges so the reader understands what they're looking at."
/>
...
- **AI Assistant**: contextual query generation, schema-aware suggestions, error correction
