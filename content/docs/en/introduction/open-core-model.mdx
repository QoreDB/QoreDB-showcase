...
If you want the full legal text, see the [LICENSE](https://github.com/QoreDB/QoreDB/blob/main/LICENSE) (Apache 2.0) and [LICENSE-BSL](https://github.com/QoreDB/QoreDB/blob/main/LICENSE-BSL) files in the repository.
