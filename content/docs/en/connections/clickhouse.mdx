...
<Callout type="info">
**Backups**: ClickHouse is not covered by the built-in backup helpers in v0.1.31. Use ClickHouse's native `BACKUP TO …` syntax from the SQL editor, or your cluster's snapshot tooling.
</Callout>
