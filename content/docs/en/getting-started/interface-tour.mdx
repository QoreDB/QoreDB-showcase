...
Press <KeyboardShortcut shortcut="Cmd+K" /> to open the global search palette. From a single fuzzy-search box you can find and jump to:
...
Open settings with <KeyboardShortcut shortcut="Cmd+," />, from the title bar, or via the command palette. Settings are organized into sections:
