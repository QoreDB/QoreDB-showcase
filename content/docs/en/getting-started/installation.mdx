...
The fastest way to install QoreDB is to grab the installer for your platform from the [Releases page](https://github.com/QoreDB/QoreDB/releases).
...
| **Windows**| Use Settings → Apps → QoreDB → Uninstall. App data is under `%LOCALAPPDATA%\com.qoredb.*`. |
