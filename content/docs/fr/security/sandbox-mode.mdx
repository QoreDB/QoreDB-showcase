...
Basculez la sandbox depuis la barre de titre (icône Fiole) ou avec <KeyboardShortcut shortcut="Cmd+Shift+S" /> (⌘⇧S sur macOS, Ctrl+Maj+S sur Windows/Linux). La sandbox est **par session**, c'est-à-dire par connexion active : l'activer pour une connexion n'affecte pas les autres.
