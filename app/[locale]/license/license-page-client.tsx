          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <section className="rounded-3xl border border-(--q-border) bg-(--q-bg-1) p-6">
              ...
              <form onSubmit={handleStatus} className="space-y-4">
                <div>
                  <label
                    htmlFor="license-status-email"
                    className="text-sm text-(--q-text-2)"
                  >
                    {t("license_management.fields.email")}
                  </label>
                  <input
                    id="license-status-email"
                    type="email"
                    required
                    value={statusEmail}
                ...
                <div>
                  <label
                    htmlFor="license-status-payment-id"
                    className="text-sm text-(--q-text-2)"
                  >
                    {t("license_management.fields.payment_id")}
                  </label>
                  <input
                    id="license-status-payment-id"
                    required
                    value={paymentId}
            ...
            <section className="rounded-3xl border border-(--q-border) bg-(--q-bg-1) p-6">
              ...
              <form onSubmit={handleResend} className="space-y-4">
                <div>
                  <label
                    htmlFor="license-resend-email"
                    className="text-sm text-(--q-text-2)"
                  >
                    {t("license_management.fields.email")}
                  </label>
                  <input
                    id="license-resend-email"
                    type="email"
                    required
                    value={resendEmail}
