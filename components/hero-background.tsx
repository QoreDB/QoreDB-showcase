				...
				<div className="absolute inset-0">
					...
					>
						<defs>
							...
							{/* 
                  THREAD FADES
                  - Critical fix: Use opacity instead of hard black for Light/Dark mode compatibility
                  - Original: stopColor="rgba(0,0,0,1)" -> New: stopColor="var(--q-accent)" stopOpacity="0"
              */}
						...
						<g>
							{/* Hero text background shapes - Widened to cover full width */}
							<ellipse
								cx="600"
								cy="350"
								rx="900"
